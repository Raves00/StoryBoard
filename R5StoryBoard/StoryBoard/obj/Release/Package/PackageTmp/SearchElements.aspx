    ...
    <div id='table-container' style="height: 500px">
        <asp:GridView ID="gvPageElements" runat="server" CssClass="gvPageElements" AutoGenerateColumns="False" DataKeyNames="ElementID" EmptyDataText="There are no data records to display." OnRowDataBound="gvPageElements_RowDataBound" CellPadding="4" ForeColor="#333333" GridLines="None" OnPreRender="gvPageElements_PreRender" OnRowDeleting="gvPageElements_RowDeleting">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="WP ControlType" SortExpression="ControlType">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="SSP ControlType" SortExpression="ControlType">
                    <ItemTemplate>
                        <asp:DropDownList ID="ddlSSPControlType" runat="server" DataTextField="ControlTypeDesc" DataValueField="ControlTypeID" CssClass="ControlType">
                        </asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="WP Is Required" SortExpression="IsRequired">
                    <ItemTemplate>
                        <asp:DropDownList ID="ddllsRequired" runat="server" DataTextField="Text" DataValueField="ID" CssClass="IsRequired">
                        </asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="SSP Is Required" SortExpression="IsRequired">
                    <ItemTemplate>
                        <asp:DropDownList ID="ddlSSPlsRequired" runat="server" DataTextField="Text" DataValueField="ID" CssClass="IsRequired">
                        </asp:DropDownList>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="WP Display Rule" SortExpression="DisplayRule">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="SSP Display Rule" SortExpression="SSP DisplayRule">
                    <ItemTemplate>
                        <asp:TextBox ID="txtSSPDisplayRule" runat="server" Text='<%# StoryBoard.SBHelper.DecodeData(Convert.ToString(DataBinder.Eval(Container.DataItem,"SSP_DisplayRule"))) %>' Height="60px" TextMode="MultiLine" Width="300px" CssClass="DisplayRule"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="WP Validations" SortExpression="Validations">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="SSP Validations" SortExpression="SSP Validations">
                    <ItemTemplate>
                        <asp:TextBox ID="txtSSPValidations" runat="server" Text='<%# StoryBoard.SBHelper.DecodeData(Convert.ToString(DataBinder.Eval(Container.DataItem,"SSP_Validations"))) %>' Height="60px" TextMode="MultiLine" Width="300px" CssClass="Validations"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="WP Error Code" SortExpression="ErrorCode">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="SSP Error Code" SortExpression="ErrorCode">
                    <ItemTemplate>
                        <asp:TextBox ID="txtSSPErrorCode" runat="server" Text='<%# StoryBoard.SBHelper.DecodeData(Convert.ToString(DataBinder.Eval(Container.DataItem,"SSP_ErrorCode"))) %>' Height="60px" TextMode="MultiLine" Width="300px" CssClass="ErrorCode"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="DatabaseTableName" Visible="false" SortExpression="DatabaseTableName">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="DatabaseTableFields" Visible="false" SortExpression="DatabaseTableFields">
                    <ItemTemplate>
